          ...
          <div class="checkout-content" >
            ...
            <div class="row justify-content-center">
              <div class="col-xl-6 col-lg-8 col-md-8">
                <form action="http://aaryaweb.info/html/shopstyle/sht001/order-overview.html" class="main-form full">
                  <div class="row mb-20">
                    ...
                    <div class="col-md-12"> 
                      <a href="${pageContext.request.contextPath}/order-overview" class="btn btn-color right-side">Next</a> 
                    </div>
                  </div>
